<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UpdatePanelTimeoutWithAjaxControlToolkit.Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Animated="true" TargetControlID="TextBox1" />
        </div>
        <div>
